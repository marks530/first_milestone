...
This happened just as I was finalising the project. I also noticedI tried several fixes uninstalling the open browser extension reloading the Font Awesome link but nothing would work. I found a new source of free icons [icons8](https://icons8.com/icons/set/popular) which was very easy to use and easy to download the images. 
